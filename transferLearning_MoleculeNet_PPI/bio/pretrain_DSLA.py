...
from loader import BioDataset_candidate, list_collate_fn
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default = 'unsupervised', help='root directory of dataset.')
    ...
    #set up dataset
    dataset = BioDataset_candidate("dataset/" + args.dataset, data_type='unsupervised', \
                                        edge_pert_strength=args.edge_pert_strength, mask_strength=args.mask_strength, \
